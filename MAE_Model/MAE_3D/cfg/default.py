...
_c.system.ckpt_dir = '/opt/localdata/data/usr-envs/MAPSEG/MAPSeg-main/ckpt'
...
'''
    ...
    mae_root
        ...
        |--- tgt_2_train
'''
_c.data.mae_root = '/opt/localdata/data/usr-envs/MAPSEG/MAPSeg-main/mae_train'
_c.data.mae_domain = '/opt/localdata/data/usr-envs/ruiying/Code/NeurIPS/MAPSeg-main/cfg/example_yaml/mae_domain.txt'
_c.data.mae_test_list = '/opt/localdata/data/usr-envs/ruiying/Code/NeurIPS/MAPSeg-main/cfg/example_yaml/sub_list_final.csv'
...
_c.model.pretrain_model = '/opt/localdata/data/usr-envs/MAPSEG/MAPSeg-main/pretrain_model/model_infant8k_pretrained.pth'
