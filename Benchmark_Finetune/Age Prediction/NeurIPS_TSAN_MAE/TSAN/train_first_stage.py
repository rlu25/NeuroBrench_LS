...
def main(res):
    ...
    opt.mae_pretrain_path = "/opt/localdata/data/usr-envs/wenyi/TSAN_MAE/TSAN-brain-age-estimation/TSAN/MAE_train_model/model_final.pth"
    if opt.mae_pretrain_path:
        mae_pretrain_path = opt.mae_pretrain_path  # Add this to your config
        model.initialize_encoder_from_pretrained(mae_pretrain_path)
